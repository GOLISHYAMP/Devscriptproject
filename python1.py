...
while (c == True):
 ...
 12. Pisces
 ''')
 s = int(input("Enter the number of your Zodiac\n")) 
 ...
 if s==1:
    ...
    print("Today, your enthusiasm for s1ports and outdoor activities is palpable. According to you, variety is the spice of life. You will keep on jumping from one venture to another. You will establish a good rapport with your bosses and colleagues. It's time to taste success in your immediate and interim objectives.")
 elif s==4:
    ...
    print("Make sure you typed the correct number between 1 to 12")
 print('''
 Do you want to go with another one?
 if YES : press any letter
 if NO  : press "N"
 ''')
 d=input()
 if d == "N":
